...
> = {
  ...
  'nava-home': {
    name: 'Household',
    promise: 'Software I use at home',
    order: 5,
  },
}
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    status: 'beta',
    href: APP_LINKS['gst-whatsapp-biller'],
  },
  {
    slug: 'follow-up-fox',
    name: 'Follow-Up Fox',
  ...
  },
  {
    ...
    features: [
      ...
      'Email/SMS alerts',
      'Public status page',
      'Watches Nava products too — used on our own tools',
    ],
    price: 'Free for 3 monitors · ₹199/mo for 25',
    status: 'beta',
    href: APP_LINKS['uptime-peek'],
  },
  ...
  },
  {
    ...
    status: 'beta',
    href: APP_LINKS['testimonial-jar'],
  },
  {
    slug: 'review-radar',
    name: 'Review Radar',
