...
import { buildUpiLink, buildWhatsAppLink } from '@/apps/getpaid/lib/links'
...
export function CourseShipApp() {
  ...
  const courseUrl = () =>
    `${window.location.origin}/tools/course-ship/learn#${encodeShare(course)}`
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-border bg-surface p-6">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          ...
          {course.price > 0 && (
            <button
              onClick={() => copy('pitch', `${window.location.origin}/tools/course-ship/pitch#${encodeShare(course)}`)}
...
export function CourseLearnApp() {
  ...
  return (
    <div className="mx-auto max-w-content space-y-5">
      ...
      <p className="text-center text-xs text-text-muted">Hosted with Course Ship — Verity Studio</p>
    </div>
  )
}
...
export function CoursePitchApp() {
  ...
  return (
    <div className="mx-auto max-w-md space-y-4 text-center">
      ...
      <p className="text-xs text-text-muted">Sold with Course Ship — Verity Studio</p>
    </div>
  )
}
