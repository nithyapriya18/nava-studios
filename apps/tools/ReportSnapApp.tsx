    ...
    <div className="grid gap-8 lg:grid-cols-2">
      <div className="space-y-4 print:hidden">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            onClick={async () => {
              const url = `${window.location.origin}/tools/report-snap/view#${encodeShare(r)}`
              try {
...
export function ReportViewApp() {
  ...
  return (
    <div className="mx-auto max-w-content space-y-4">
      ...
      <p className="text-center text-xs text-text-muted print:hidden">Report Snap — Verity Studio</p>
    </div>
  )
}
