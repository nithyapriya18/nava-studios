  ...
  <body style="font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica,Arial; color:#1F1B16; background:#FBF7F0; padding:24px;">
    <div style="max-width:820px; margin:0 auto; background:#FFFFFF; border:1px solid #E6D9C8; border-radius:18px; padding:22px;">
      ...
      <div style="color:#6B5E52; font-size:11px; margin-top:14px;">
        Generated by Nava Studios GST Mobile. Utility summary — not tax advice.
      </div>
    </div>
  </body>
</html>`
...
const styles = StyleSheet.create({
  ...
  totalsKey: { color: colors.chipTextActive, opacity: 0.8, fontSize: typography.small, fontWeight: '800' },
  totalsVal: { color: colors.chipTextActive, fontSize: typography.small, fontWeight: '900' },
  totalsRowStrong: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    marginTop: spacing.sm,
  ...
  totalsKeyStrong: { color: colors.chipTextActive, fontSize: typography.body, fontWeight: '900' },
  totalsValStrong: { color: colors.chipTextActive, fontSize: typography.body, fontWeight: '900' },
})
