...
const stages = [
  {
    ...
    Icon: Search,
    description:
      'A focused conversation on the problem. I come back with a one-page plan: what to build, how long it takes, and what it costs. You decide whether to continue.',
  },
  {
    number: 2,
